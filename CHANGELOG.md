...
## [0.9.41](https://github.com/Simulink-new/deep-student/compare/v0.9.40...v0.9.41) (2026-09-10)
...
* add database maintenance mode + fix Windows file lock (OS error 32) during restore ([7023510](https://github.com/Simulink-new/deep-student/commit/7023510b76afcb23149ba0271e9c020c102c9608))
...
* enhance progress tracking for backup/restore/import operations with detailed error reporting ([39502db](https://github.com/Simulink-new/deep-student/commit/39502dbac74a64b701e988a75a6976f1d6fb8111))
...
* improve mobile UI layout + migrate template buttons to NotionButton ([afd62b4](https://github.com/Simulink-new/deep-student/commit/afd62b4bb278f8790ff9918e0080e6d8cc36939f))
...
* mobile dual download links (R2 mirror + GitHub) ([0b4e4e5](https://github.com/Simulink-new/deep-student/commit/0b4e4e55aa3a1ebd79cff527e9fca4f570e674a2))
...
* prioritize R2 mirror for auto-update source ([f9c3b35](https://github.com/Simulink-new/deep-student/commit/f9c3b35ccad0854eda00e3f18f2bcc7cd4b8a190))
...
* source image crop, search snippets, remove question_parsing_model ([9ed6315](https://github.com/Simulink-new/deep-student/commit/9ed6315c43432eaf80aa5d588e2cf52367e7277f))
...
* **tools:** add DOCX document read/write tool executor + Excel/PowerPoint dependencies ([2a7546a](https://github.com/Simulink-new/deep-student/commit/2a7546a942b55d8bbf163f6e22ea9239d1baf988))
* **tools:** add PPTX/XLSX tool executors with full read/write capabilities ([d3f6bc5](https://github.com/Simulink-new/deep-student/commit/d3f6bc52d5899a7def675f16adb815bd08536421))
...
* add --remote flag to wrangler r2 commands ([2ede0e7](https://github.com/Simulink-new/deep-student/commit/2ede0e72cf00a51f2335c58c02d4d21d6e7ad9b3))
...
* **android:** disable ppt-rs default features to avoid openssl-sys ([43c3b66](https://github.com/Simulink-new/deep-student/commit/43c3b66c3f4e8bdfa51fbd8538e17c1e809e722f))
...
* **ci:** prevent dependabot major bumps + precise semver extraction ([394deff](https://github.com/Simulink-new/deep-student/commit/394deff5acd3ff51c8ae2725aba0051b524f11a2))
...
* critical review fixes for R2 upload in release workflow ([2e2b32d](https://github.com/Simulink-new/deep-student/commit/2e2b32db321d44e30a5ac6eab9e23689b01e796c))
* **deps:** migrate json_validator to jsonschema 0.42 API ([7749723](https://github.com/Simulink-new/deep-student/commit/774972354c50dc9115066c655d3d6b2ca257bfc2))
...
* improve tool call argument parsing + add paper save fallback handling + add purge safety checks ([bf94e37](https://github.com/Simulink-new/deep-student/commit/bf94e3753fbed6c48450424e286d3da629fde6d2))
* improve tool schema parameter formats to reduce LLM confusion ([2b24b1e](https://github.com/Simulink-new/deep-student/commit/2b24b1ea7248ac25849f3b3db233b0475059957d))
...
* **release:** disable component-prefixed tags + robust version extraction ([5b50a4b](https://github.com/Simulink-new/deep-student/commit/5b50a4b5777ce2ef1a1de1c02c40f55d76bc46ba))
...
* **restore:** 恢复备份写入非活跃插槽，避免 Windows OS error 32 ([af6c11f](https://github.com/Simulink-new/deep-student/commit/af6c11f89a51f47d88035172f83bf0a9f63f44e5))
...
* switch to rclone for R2 upload (native Cloudflare provider) ([c20f5af](https://github.com/Simulink-new/deep-student/commit/c20f5afde9adc1fbfc9bf6cb43f6c9beafef1ded))
* switch to wrangler CLI for R2 upload (bypass S3 TLS issue) ([643b8ad](https://github.com/Simulink-new/deep-student/commit/643b8ad1866c1112f9461d1dca873f75dd207f9f))
...
* **updater:** robust version extraction from tag_name for Android ([0e13205](https://github.com/Simulink-new/deep-student/commit/0e132050c2dd04b1addc8075040cc3aef0fafe66))
...
* use GitHub API for R2 version cleanup (wrangler has no list command) ([3f5903c](https://github.com/Simulink-new/deep-student/commit/3f5903c6b858d0044cd5734703e122b3f6f464ad))
* use path-style addressing for R2 S3 compatibility ([fa0157b](https://github.com/Simulink-new/deep-student/commit/fa0157b6a16b70f3c4d8efd0691b925f7fbea884))
...
* add cache-control headers and proper content-types for R2 uploads ([78b2325](https://github.com/Simulink-new/deep-student/commit/78b23254cb80984bbc7f810f81a63b07b612c601))
